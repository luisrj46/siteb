<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('password.update') }}">
        ...
        <div class="fv-row mb-8">
            <!--begin::Repita la contraseña-->
            <input placeholder="Repita la contraseña" name="password_confirmation" type="password" autocomplete="off" class="form-control bg-transparent"/>
            <!--end::Repita la contraseña-->
        </div>
        <!--end::Input group--->
        ...
        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
            <a href="{{ route('login') }}" class="btn btn-light mx-4">Cancelar</a>
            <x-buttons.indicator type="button" id="kt_new_password_submit" class="btn-primary me-4" label="Cambiar contraseña" />
        </div>
        <!--end::Actions-->
    </form>
    <!--end::Form-->
