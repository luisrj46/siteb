...
<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end mb-5 mb-xl-10" style="background-color: #77d4fc;">
	<!--begin::Header-->
    <h2 class="text-center pt-3">Equipos biomédicos</h2>
	<div class="card-header pt-1">
		<!--begin::Title-->
		<div class="card-title d-flex flex-column">
			<!--begin::Amount-->
			<span class="fs-2hx fw-bold me-2 lh-1 ls-n2">{{$result->equipment?->total}}</span>
			<!--end::Amount-->
			<!--begin::Subtitle-->
	...
	<div class="card-header pt-2">
		...
		<div class="card-title d-flex flex-column">
			<!--begin::Amount-->
			<span class="fs-1hx fw-bold me-2 lh-1 ls-n2">{{$result->equipment?->enabled}}</span>
			<!--end::Amount-->
			<!--begin::Subtitle-->
	...
	<div class="card-header pt-2">
		...
		<div class="card-title d-flex flex-column">
			<!--begin::Amount-->
			<span class="fs-1hx fw-bold me-2 lh-1 ls-n2">{{$result->equipment?->disabled}}</span>
			<!--end::Amount-->
			<!--begin::Subtitle-->
