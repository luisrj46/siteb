...
<div class="app-sidebar-logo px-3 " id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="/">
		<img style="background-color: #fff; border-radius: 4px;" alt="Logo" src="{{ image('logos/siteb.png') }}" class="h-60px py-1 app-sidebar-logo-default" />
		<img style="background-color: #fff; border-radius: 4px;" alt="Logo" src="{{ image('logos/logo_selah_icon.png') }}" class="h-40px app-sidebar-logo-minimize" />
	</a>
