<form id="kt_modal_user_form" method="DELETE" class="form" action="{{ route('maintenances.destroy', $record->id) }}">
    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true"
        ...
        data-kt-scroll-offset="300px">
            <x-forms.label.index label='Esta seguro que desea eliminar el mantenimiento {{ $record->name }} - {{ $record->id }} ?' />
    </div>
</form>
